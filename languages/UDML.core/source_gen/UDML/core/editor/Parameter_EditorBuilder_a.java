...
/*package*/ class Parameter_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.direction$94gb;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.type$94vc;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.type$94vc);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.type$94vc);
    }
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_0() {
      ...
      editorCell.setCellId("ReferencePresentation_2k1i0x_a0b0");
      return editorCell;
    }
  }

  private static final class PROPS {
    /*package*/ static final SProperty direction$94gb = MetaAdapterFactory.getProperty(0xfd381d931dce4228L, 0xba53a4e0ecaf0da2L, 0x49e02d1c64bbef94L, 0x49e02d1c64bbef98L, "direction");
  }
