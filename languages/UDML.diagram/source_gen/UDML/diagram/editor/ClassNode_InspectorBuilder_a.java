...
/*package*/ class ClassNode_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ClassNode_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_f6geex_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_f6geex_0");
